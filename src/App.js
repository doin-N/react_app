...
//리스트 지우기
  ...
  const handleSubmit = (e) => {
    ...
    if(charge !== "" && amount > 0 ) {
      ...
      handleAlert ({type: "danger", text: "charge는 빈 값일 수 없으며 amount 값음 0보다 커야 합니다."});
    }
  }
      ...
      <main className="main-container" >
        <div className="sub-container" >
          ...
          <div style = {{ width: '100%', backgroundColor: 'white', padding: '1rem' }}>
            {/* Expense Form */} 
            <ExpenseForm edit={edit} charge={charge} handleSubmit={handleSubmit} 
